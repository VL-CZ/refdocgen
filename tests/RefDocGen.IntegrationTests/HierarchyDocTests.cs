...
public class HierarchyDocTests
{
    ...
    {
        using var document = DocumentationTools.GetApiPage($"MyLibrary.Hierarchy.{typeName}.html");
    ...
    {
        using var document = DocumentationTools.GetApiPage("MyLibrary.Hierarchy.ChildChild.html");
