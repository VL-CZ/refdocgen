...
/// <param name="DocComment">Documentation comment for the indexer.</param>
...
public record IndexerTM(IEnumerable<ParameterTM> Parameters, string Type, string DocComment, IEnumerable<string> Modifiers, bool HasGetter, bool HasSetter,
