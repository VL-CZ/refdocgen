...
[![NuGet Downloads](https://img.shields.io/nuget/dt/RefDocGen)
](https://www.nuget.org/packages/RefDocGen)
[![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/VL-CZ/refdocgen/dotnet.yml)
