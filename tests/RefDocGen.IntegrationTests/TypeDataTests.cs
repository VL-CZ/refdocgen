...
public class TypeDataTests
{
    ...
    {
        using var document = TestTools.GetDocumentationPage("MyLibrary.Tools.Collections.MySortedList`1.html");
        string[] constraints = TestTools.GetTypeParamConstraints(document.GetTypeDataSection());
    ...
    public void Test_Method_Constraints()
    {
        ...
        string[] constraints = TestTools.GetTypeParamConstraints(method);
    ...
    {
        using var document = TestTools.GetDocumentationPage("MyLibrary.Tools.Collections.MyDictionary`2.html");
        string[] constraints = TestTools.GetTypeParamConstraints(document.GetTypeDataSection());
    ...
    public void Test_BaseType(string pageName, string expectedBaseType)
    {
        ...
        string baseType = TestTools.GetBaseTypeName(document.GetTypeDataSection());
    ...
    public void Test_Interfaces(string pageName, string expectedInterfacesImplemented)
    {
        ...
        string interfaces = TestTools.GetInterfacesString(document.GetTypeDataSection());
    ...
    public void Test_Namespace(string pageName, string expectedNamespace)
    {
        ...
        string ns = TestTools.GetNamespaceString(document.GetTypeDataSection());
