...
internal class AssemblyTypeExtractor
{
    ...
    internal AssemblyTypeExtractor(string assemblyPath, AccessModifier minAccessibility)
    {
    ...
    internal TypeRegistry GetDeclaredTypes()
    {
        ...
        var visibleTypes = assembly
            .GetTypes()
            .Where(t => !t.IsCompilerGenerated()) // exclude types generated by the compiler
            .Where(t => AccessModifierHelper.GetAccessModifier(t).IsAtMostAsRestrictiveAs(minAccessibility)); // select only the types that are visible
        ...
        return new TypeRegistry(objectTypesData, enumsData, delegatesData);
    }
    ...
    private ObjectTypeData ConstructObjectType(Type type)
    {
        ...
        var objectType = new ObjectTypeDataBuilder(type, minAccessibility)
